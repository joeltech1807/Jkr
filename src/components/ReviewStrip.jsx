...
const reviews = [
  { id: 1, stars: 5, text: "Precision laser cutting at its best. Perfect for our architectural project.", name: "Rajesh Kumar" },
  { id: 2, stars: 5, text: "Outstanding quality and service. Our industrial doors were perfectly installed.", name: "Sarah Mitchell" },
  { id: 3, stars: 5, text: "Go-to partner for fabrication. Impressive attention to detail and deadlines.", name: "Amit Sharma" },
  { id: 4, stars: 5, text: "Premium finish and robust build. Exceptional craftsmanship on our facades.", name: "David Thompson" }
];
...
const ReviewStrip = () => {
  ...
  return (
    <div className="review-strip-container" ref={containerRef}>
